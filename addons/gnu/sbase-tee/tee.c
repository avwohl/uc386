/* Verbatim from sbase: https://git.suckless.org/sbase/file/tee.c.html
 *
 * Imported as a real upstream port for uc386. The only adapter is
 * util.h in this directory (a minimal shim — see addons/gnu/sbase-tee/
 * util.h for what it provides). License: MIT (see LICENSE).
 */
